...
Base = 'https://4723h.blogspot.com/p/lista-freexml.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.tutoshugo') #    modificar("el nombre de tu addons")
